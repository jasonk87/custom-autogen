...
function renderTeam() {
  ...
  if (!agents.length) {
      teamContainer.innerHTML = '<div style="color:#9ca3af; padding:8px; text-align:center;">No agents in team. Add manually or generate from scenario.</div>';
      return
  }
