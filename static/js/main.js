...
function renderTeam(){ const teamContainer=$('#team'); if(!agents.length){ teamContainer.innerHTML='<div style="color:#9ca3af">Add at least two agents.</div>'; return } teamContainer.innerHTML=agents.map((agent,i)=>`
      <div class='team-item'>
...
document.addEventListener('DOMContentLoaded',()=>{ initGraph(); setupTabs();
